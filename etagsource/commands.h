...
//~~~~~~~~~~~CMD_ETAG_GW_HB_FEEDBACK_STATE~~~~~~~~~~~~~~~~
#define CMD_ETAG_GW_HB_FEEDBACK_STATE 0x3f
#define SUBCMD_GW_STATE 0x01
#define STATE_LENGTH 1
#define ETAG_GW_HB_FEEDBACK_STATE_LENGTH (CMD_LENGTH+ MAC_BYTE_LENGTH +SUBCMD_LENGTH+STATE_LENGTH)//9
...
//~~~~~~~~~~~CMD_ETAG_GW_HB_FEEDBACK_STATE~~~~~~~~~~~~~~~~
#define CMD_TAG_ETAG_GW_HB_FEEDBACK_STATE 0x92
#define ETAG_HB_FEEDBACK_HEADER_LENGTH (CMD_LENGTH+ MAC_BYTE_LENGTH +SUBCMD_LENGTH+MAC_BYTE_LENGTH+STATE_LENGTH)//15
#define SUBCMD_TAG_STATE 0x01


//~~~~~~~~~~~CMD_TAG_ETAG_GW_HB_FEEDBACK_STATE ONUART~~~~~~~~~~~~~~~~
//#define CMD_TAG_ETAG_GW_HB_FEEDBACK_STATE 0x92
#define TAG_ETAG_GW_HB_FEEDBACK_STATE_ONUART_HEADER_LENGTH (CMD_LENGTH+MAC_BYTE_LENGTH+SUBCMD_LENGTH+STATE_LENGTH)//9



//~~~~~~~~~~~CMD_TAG_ETAG_GW_HB_FEEDBACK_STATE ONBLE~~~~~~~~~~~~~~~~
//#define CMD_TAG_ETAG_GW_HB_FEEDBACK_STATE 0x92
#define TAG_ETAG_GW_HB_FEEDBACK_STATE_ONBLE_HEADER_LENGTH (CMD_LENGTH+SUBCMD_LENGTH+STATE_LENGTH)//3
...
#define BLESCAN_TYPE_SENDNEWSHORTPW 1
#define BLESCAN_TYPE_HB 2
